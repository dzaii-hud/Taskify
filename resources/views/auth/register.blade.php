...
@section('content')
    <section class="w-full max-w-4xl grid gap-10 md:grid-cols-2 items-center">
        {{-- Side kiri: benefit buat user baru (konsep sama kayak login) --}}
        <div
        ...
        {{-- Side kanan: form register (isi khusus register) --}}
        <div class="w-full">
            <div class="bg-white/95 backdrop-blur rounded-3xl shadow-xl border border-slate-100 p-6 sm:p-8 space-y-6">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <p class="text-[11px] sm:text-xs uppercase tracking-[0.25em] text-slate-400">
                            BUAT AKUN BARU
                        </p>
